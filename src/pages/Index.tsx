...
const Index = () => {
  ...
  Who We Are
                ...
                <div className="mt-4 h-1 w-24 bg-gradient-to-r from-accent to-transparent rounded-full" />
  ...
  What We Do
              ...
              <div className="mx-auto mt-4 h-1 w-24 rounded-full bg-gradient-to-r from-accent to-transparent" />
  ...
  <div className="container-narrow relative">
    <FadeIn>
      <div className="text-center max-w-2xl mx-auto">
        ...
        {/* Heading */}
        <h2 className="mt-4 text-3xl font-heading font-bold md:text-5xl text-primary">
          How It Works
        </h2>
        ...
        <p className="mt-4 text-muted-foreground">
          A simple 4-step journey to your Saudi business
        </p>
      </div>
    </FadeIn>
      ...
      {[
        {
          ...
          desc: "Discuss your goals and get expert advice.",
        },
        {
          num: "02",
          title: "Document Preparation",
          desc: "We handle all paperwork and filings.",
        },
        {
          num: "03",
          title: "Government Processing",
          desc: "Approvals, licenses, and registrations.",
        },
        {
          num: "04",
          title: "Business Launch",
          desc: "Start operating with ongoing support.",
        },
      ].map((step, i) => (
  ...
  Why Us
        ...
        <p className="mt-4 text-white/70">
          What sets us apart in business consulting
        </p>
    ...
    <div className="mt-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
      {whyUs.map((item, i) => (
        <FadeIn key={item.title} delay={i * 80}>
          <Card className="group h-full border-white/10 bg-white/5 backdrop-blur transition-all duration-500 hover:border-accent/30 hover:shadow-xl hover:shadow-accent/10 hover:-translate-y-2">
            <CardContent className="p-8">

              <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-xl bg-accent/20 text-accent transition-all group-hover:bg-accent group-hover:text-accent-foreground group-hover:shadow-lg group-hover:shadow-accent/30">
                <item.icon size={22} />
              </div>
